                ...
                },
                {
                    ...
                    render: (text: string, record: any) => (
                        <Button
                            ...
                            onClick={() => this.showEncryptModal(record)}
                        >
                            隔离
                        </Button>
                    ),
    ...
    renderDecryptModal = () => {
        return (
            <Modal
                ...
                cancelText="取消"
                okButtonProps={{
                    style: { backgroundColor: '#1664FF', borderColor: '#1890ff', color: '#fff' },
                }}
            >
                <Descriptions bordered column={1}>
                    <Descriptions.Item label="Agent UUID">
                        {this.state.currentRecord.uuid}
                    </Descriptions.Item>
                    <Descriptions.Item label="原文件名称">
                        {this.state.currentRecord.origin_filename}
                    </Descriptions.Item>
                    <Descriptions.Item label="原文件路径">
                        {this.state.currentRecord.origin_filepath}
                    </Descriptions.Item>
                    <Descriptions.Item label="加密文件名称">
                        {this.state.currentRecord.encrypted_filename}
                    </Descriptions.Item>
                    <Descriptions.Item label="加密文件路径">
                        {this.state.currentRecord.encrypted_filepath}
                    </Descriptions.Item>
                </Descriptions>
            </Modal>
        );
        ...
        return (
            <DataContext.Consumer>
                {(context: DataContextType | undefined) => {
                    ...
                    const { monitoredOriginData, virusOriginData, isolationOriginData } = context;
