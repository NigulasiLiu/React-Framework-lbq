...
import { Steps, Form, Input, Button, Row, Alert, Radio, Card, message, Switch, DatePicker, Col, Table } from 'antd';
...
import { fetchDataFromAPI, handleExport } from '../ContextAPI/DataService';
...
class CreateTaskPage extends React.Component<CreateTaskPageProps, CreateTaskPageState> {
    ...
    // 回调函数，用于更新 selectedUuids
    updateSelectedUuids = (selectedUuids: React.Key[]) => {
                                    ...
                                    <Card style={{ width: '90%', margin: '0px auto' }}>
                                            <Row style={{ margin: '0px auto', width: '100%' }}>
                                                <HostListTable
                                                    ...
                                                    updateSelectedUuids={this.updateSelectedUuids} // 将回调函数作为 props 传递
                                                />
                                            </Row>
                                            <Row style={{
                                            ...
                                            >
                                                <Row>
                                                    <Row style={{
                                                        ...
                                                        <Form.Item
                                                            label={<span
                                                                style={{ fontSize: '18px' }}>将要下发任务的主机</span>}
                                                            name="description">
                                                            <p style={{
                                                        ...
                                                        <Row style={{ width: '100%' }}>
                                                            <Col span={24}>
                                                                <Form.Item label="表达式" name="expression"
                                                                    ...
                                                                    <Input
                                                                        placeholder={selectedTaskType === 'interval' ?
