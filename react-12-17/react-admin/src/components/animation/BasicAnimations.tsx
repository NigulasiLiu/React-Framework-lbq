...
class BasicAnimations extends React.Component<BasicAnimationsProps,BasicAnimationsState> {
    ...
    renderCurrentPanel() {
        ...
        case 'container':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files1"
        ...
        case 'open-ports':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files2"
        ...
        case 'running-processes':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files3"
        ...
        case 'system-users':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files4"
        ...
        case 'scheduled-tasks':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files5"
        ...
        case 'system-services':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files6"
        ...
        case 'system-software':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files7"
        ...
        case 'applications':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files8"
        ...
        case 'kernel-modules':
            return (
                <GenericDataDisplay
                apiEndpoint="http://localhost:5000/api/files9"
