...
// const columns = [
//   {
//     title: () => <span style={{ fontWeight: 'bold' }}>开放端口 TOP5</span>,
//     key: 'id',
//     render: (text: any, record: DataItem, index: number) => {
//       // 根据背景颜色选择文本颜色
//       const textColor = index < 3 ? 'white' : 'grey'; // 前三个使用白色，其余使用灰色
//       return (
//         <div>
//           <span style={{
//             lineHeight: '15px',
...
// 每个table的标题
const tableNames = ["开放端口 TOP5","系统软件 TOP5","系统服务 TOP5","运行进程 TOP5",
      "系统完整性校验-最新变更二进制文件 TOP5","应用 TOP5","内核模块 TOP5","容器运行状态分布",];
const tableName_s = ["指纹数","变更时间",''];
const columns = [generateColumns(tableNames[0], tableName_s[0],tableNames),generateColumns(tableNames[1], tableName_s[0],tableNames),
generateColumns(tableNames[2], tableName_s[0],tableNames),generateColumns(tableNames[3], tableName_s[0],tableNames),
generateColumns(tableNames[4], tableName_s[1],tableNames),generateColumns(tableNames[5], tableName_s[0],tableNames),
generateColumns(tableNames[6], tableName_s[0],tableNames),generateColumns(tableNames[7], tableName_s[2],tableNames),]
      ...
      <div style={{ fontFamily: "'YouYuan', sans-serif",fontWeight: 'bold'}}>
        <Row gutter={[8, 16]}>
              ...
              <Row >
                ...
                <Col span={2} style={{ position: 'relative', top: '-3.5px' }}>
                  <Button
                    type="link"
                    icon={<RightOutlined />}
                    onClick={this.goToContainerPanel}
                  />
                </Col>
              </Row>
            </Card>
          ...
          <Col span={2}>
            <Card bordered={false} style={{
              ...
              <Row >
                ...
                <Col pull={0} span={2} style={{ position: 'relative', top: '-3.5px' }}>
                  <Button
                    type="link"
                    icon={<RightOutlined />}
                    onClick={this.goToContainerPanel}
          ...
          <Col span={3}>
            <Card bordered={false} style={{
              ...
              <Row >
                <Col pull={2} span={22} >
                  <Statistic title={<span >系统完整性校验</span>} value={0} />
                </Col>
                <Col pull={0} span={2} style={{ position: 'relative', top: '-3.5px' }}>
                  <Button
                    type="link"
        ...
        <Row gutter={[8, 16]}>
          ...
          <Table<DataItem>
            ...
            // rowKey="id"
          />
          <Card className="noTopBorderCard"
          style={{height:238}}>
          <Row gutter={0}>
              <Col span={12} >
